...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 64, 64, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 2, 128, 128, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 64, 64, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 4, 128, 128, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 64, 64, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 8, 128, 128, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 64, 64, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 16, 128, 128, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 64, 64, 64, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 16, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 16, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 32, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 32, 256);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 64, 128);
...
register_flash_decoding_allocated_paged_lastblock_sync_buffer(f16, u8, 32, 128, 128, 64, 256);
